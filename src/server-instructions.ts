...
- Use wait=true by default when the user wants the completed result. Hosted MCP keeps that request open for up to 300 seconds and returns the terminal result in the same response stream.
